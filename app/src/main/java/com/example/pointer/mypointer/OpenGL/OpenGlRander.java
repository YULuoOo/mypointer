...
public class OpenGlRander extends GLSurfaceView implements GLSurfaceView.Renderer {
    private int mProgram;
    private int maPostionHandle;
    String TAG="OpenGLRanderss";
    ...
    public OpenGlRander(Context mContext)
    {
        super(mContext);
        setRenderer(this);
    }
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        Log.i("onserfacess","sssssssssssssssssssssssss");
