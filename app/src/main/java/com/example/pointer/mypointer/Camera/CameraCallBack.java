package com.example.pointer.mypointer.Camera;
 ...
 * 相机界面SurfaceView的回调类
 */
public final class CameraCallBack implements android.view.SurfaceHolder.Callback, Camera.PreviewCallback {

    Context context;
    static final String TAG = "Camera";
    MyCamera mFrontCamera = new MyCamera();
    boolean previewing = mFrontCamera.getPreviewing();
    Camera mCamera;
    CameraTask mFaceTask;
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        MyCamera.setCameraDisplayOrientation((Activity) context, mFrontCamera.getCurrentCamIndex(), mCamera);
    }
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        ...
        mFaceTask = new CameraTask(data, camera);
